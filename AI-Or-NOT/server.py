...
data = [
    {"id": 0, "Title": "Background Information", "Description": "Check for inconsistencies or blending of various backgrounds that might appear unnatural or out of place", "image_path": ["learn1", "back1", "back3", "back4"]},
    {"id": 1, "Title": "Repeating Items", "Description": "Identify any duplicated or cloned objects within the image that may indicate a lack of diversity or organic variation.", "image_path": ["learn2", "repeat1", "repeat2", "repeat3"]},
    ...
    {"id": 3, "Title": "Smooth Skin", "Description": " Assess the skin texture for any overly smooth or artificial appearance, which could indicate excessive manipulation or synthesis.", "image_path": ["learn4", "skin1", "skin2", "skin3"]},
    {"id": 4, "Title": "Garbled Text", "Description": " Jumbled Text: Look for any nonsensical or randomly placed text within the image that doesn't fit with the overall context.", "image_path": ["learn5", "text1", "text2", "text3"]},
...
correct_answers = [
    {"id":0, "answer": "A", "reason":"This is AI beacuse Their are weird fingers present and the hair of the blonde lady is irregular along with weird eye generations."},
    {"id":1, "answer": "A", "reason":"This is fake because the fingers are very off/odd"},
...
def calculate_score(user_answers):
    ...
    percentage_score = round(((correct_answers_count / (total_questions - 1)) * 100), 2)
